...
***Calcifying Aura.*** Any creature that starts its turn in a 10-foot emanation originating from Ygra must make a DC 18 Constitution saving throw. On a failed save, a creature is restrained until the end of its next turn. If the save fails by 5 or more, the creature is also petrified.
...
***Claw.*** *Melee Weapon Attack:* +11 to hit, reach 10 ft., one target. *Hit:* 22 (3d10 + 6) slashing damage, or Ygra deals 27 (6d6 + 6) necrotic damage if it had advantage on the attack roll.

***Devour.*** One creature within 5 feet must make a DC 18 Dexterity saving throw. On a failed save, it takes 33 (6d8 + 6) piercing damage, and the target is swallowed if it is Medium or smaller. A swallowed creature is restrained, has total cover against attacks and other effects outside Ygra, and takes 14 (4d6) acid damage at the start of each of Ygra's turns. Ygra then gains temporary hit points equal to the acid damage taken. Ygra's stomach can hold up to two creatures at a time.
If Ygra takes 30 damage or more on a single turn from a creature inside it, Ygra regurgitates all swallowed creatures, each of which falls prone in a space within 10 feet of Ygra. If Ygra dies, all swallowed creatures are similarly regurgitated.
...
>
> **Season of Salt.** Ygra's arrival marks the season of Salt. This season is categorized by a withering of crops and the calcification of objects and structures with a build-up of salt. This is a season of dryness and drought; there is little rain, and many grow hungry. The Squirrelfolk ration their food cache stores during seasons such as this, to ensure the survival of the community.
>
> Treasure: Implements

![Ygra](./Images/Ygra.png)
